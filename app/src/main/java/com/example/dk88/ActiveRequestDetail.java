        ...
        call.enqueue(new Callback<ResponseObject>() {
            ...
            public void onResponse(Call<ResponseObject> call, Response<ResponseObject> response) {
                if (!response.isSuccessful()){
                    Toast.makeText(ActiveRequestDetail.this,"Error",Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void isAccept(Boolean accept){
        ...
        call.enqueue(new Callback<ResponseObject>() {
            ...
            public void onResponse(Call<ResponseObject> call, Response<ResponseObject> response) {
                ...
                if(accept){
                    Toast.makeText(ActiveRequestDetail.this,"ACTIVE SUCCESSFULLY",Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(ActiveRequestDetail.this,"DECLINED SUCCESSFULLY",Toast.LENGTH_LONG).show();
                }
                Intent intent=new Intent(ActiveRequestDetail.this,UserRequest.class);
